...
public class NaiveBayes {
    ...
    public Classificacao classificar(double tamanhoSepala, double larguraSepala, double tamanhoPetala, double larguraPetala) {
        ...
        versicolor[0] = (1 * Math.pow(neperiano, -(Math.pow(larguraPetala - mediaAritmetica, 2)) / 2 * variancia)) / Math.sqrt(2 * pi * variancia);
        ...
        versicolor[1] = (1 * Math.pow(neperiano, -(Math.pow(tamanhoPetala - mediaAritmetica, 2)) / 2 * variancia)) / Math.sqrt(2 * pi * variancia);
        ...
        versicolor[2] = (1 * Math.pow(neperiano, -(Math.pow(larguraSepala - mediaAritmetica, 2)) / 2 * variancia)) / Math.sqrt(2 * pi * variancia);
       ...
       // System.out.println("valor 3 :"+versicolor[2] );
        ...
        versicolor[3] = (1 * Math.pow(neperiano, -(Math.pow(tamanhoSepala - mediaAritmetica, 2)) / 2 * variancia)) / Math.sqrt(2 * pi * variancia);
        ...
        setosa[0] = (1 * Math.pow(neperiano, -(Math.pow(larguraPetala - mediaAritmetica, 2)) / 2 * variancia)) / Math.sqrt(2 * pi * variancia);
        ...
        setosa[1] = (1 * Math.pow(neperiano, -(Math.pow(tamanhoPetala - mediaAritmetica, 2)) / 2 * variancia)) / Math.sqrt(2 * pi * variancia);
        ...
        setosa[2] = (1 * Math.pow(neperiano, -(Math.pow(larguraSepala - mediaAritmetica, 2)) / 2 * variancia)) / Math.sqrt(2 * pi * variancia);
        ...
        setosa[3] = (1 * Math.pow(neperiano, -(Math.pow(tamanhoSepala - mediaAritmetica, 2)) / 2 * variancia)) / Math.sqrt(2 * pi * variancia);
        ...
        virginica[0] = (1 * Math.pow(neperiano, -(Math.pow(larguraPetala - mediaAritmetica, 2)) / 2 * variancia)) / Math.sqrt(2 *pi * variancia);
        ...
        virginica[1] = (1 * Math.pow(neperiano, -(Math.pow(tamanhoPetala - mediaAritmetica, 2)) / 2 * variancia)) / Math.sqrt(2 * pi * variancia);
        ...
        virginica[2] = (1 * Math.pow(neperiano, -(Math.pow(larguraSepala - mediaAritmetica, 2)) / 2 * variancia)) / Math.sqrt(2 * pi* variancia);
       ...
       // System.out.println("valor 3 : "+setosa[2]);
        ...
        virginica[3] = (1 * Math.pow(neperiano, -(Math.pow(tamanhoSepala - mediaAritmetica, 2)) / 2 * variancia)) / Math.sqrt(2 * pi * variancia);
