...
(function($) {
	...
	_oExt.oPagination = {
		...
		"full_numbers": {
			...
			"fnInit": function ( oSettings, fnCallbackDraw )
			{
				...
				nFirst.className = "paginate_img first";
				nPrevious.className = "paginate_img previous";
				nNext.className="paginate_img next";
				nLast.className = "paginate_img last";
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input id="jisco-search" type="text" />';
