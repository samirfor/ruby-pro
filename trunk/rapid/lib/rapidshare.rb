...
def gerar_html(resposta, path_do_arquivo)
  ...
  puts "Arquivo criado.\nAbrindo navegador firefox..."
  system('firefox '+path_do_arquivo)
end

def falhou(segundos)
  puts "Download falhou... Tentando novamente em #{segundos} segundos."
  sleep(segundos)
end
...
def main
  ...
  if headers.code == "200"
    ...
    wait = resposta.body.scan(/Please try again in \d+ minutes/)[0]
    if wait != nil
    ...
    puts 'Contador identificado: '+ tempo + ' segundos.'
